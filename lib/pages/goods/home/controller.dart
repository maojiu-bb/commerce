...
class HomeController extends GetxController {
  ...
  _initData() async {
    ...
    // 保存离线数据
    Storage().setString(
        Constants.storageProductsAttributesBrands, jsonEncode(attributeBrand));
    Storage().setString(Constants.storageProductsAttributesGenders,
        jsonEncode(attributeGender));
    Storage().setString(Constants.storageProductsAttributesConditions,
